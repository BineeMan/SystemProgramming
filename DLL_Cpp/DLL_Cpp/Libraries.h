...
extern "C" __declspec(dllexport) HRESULT __stdcall GetGraphicCPP(LPCWSTR FileName, int Width, int Height, HBITMAP * MyBmb);

extern "C" __declspec(dllexport) HRESULT __stdcall PointsFromTsvToXml(LPCWSTR FileName, BSTR * Xml);